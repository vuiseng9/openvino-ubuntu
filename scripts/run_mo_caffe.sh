...
cd /workspace/nn_models/classification/alexnet/caffe && 
...
cd /workspace/nn_models/classification/densenet/121/caffe && 
...
cd /workspace/nn_models/classification/densenet/161/caffe && 
...
cd /workspace/nn_models/classification/densenet/169/caffe && 
...
cd /workspace/nn_models/classification/densenet/201/caffe && 
...
cd /workspace/nn_models/classification/googlenet/v1/caffe && 
...
cd /workspace/nn_models/classification/googlenet/v2/caffe && 
...
cd /workspace/nn_models/classification/googlenet/v4/caffe && 
...
cd /workspace/nn_models/classification/inception-resnet/v2/caffe && 
...
cd /workspace/nn_models/classification/resnet/v1/101/caffe && 
...
cd /workspace/nn_models/classification/resnet/v1/152/caffe && 
...
cd /workspace/nn_models/classification/resnet/v1/50/caffe && 
...
cd /workspace/nn_models/classification/se-networks/se-inception/caffe && 
...
cd /workspace/nn_models/classification/se-networks/se-resnet-101/caffe && 
...
cd /workspace/nn_models/classification/se-networks/se-resnet-152/caffe && 
...
cd /workspace/nn_models/classification/se-networks/se-resnet-50/caffe && 
...
cd /workspace/nn_models/classification/se-networks/se-resnext-101/caffe && 
...
cd /workspace/nn_models/classification/se-networks/se-resnext-50/caffe && 
...
cd /workspace/nn_models/classification/squeezenet/1.0/caffe && 
...
cd /workspace/nn_models/classification/squeezenet/1.1/caffe && 
...
cd /workspace/nn_models/classification/vgg/16/caffe && 
...
cd /workspace/nn_models/classification/vgg/19/caffe && 
...
cd /workspace/nn_models/face_recognition/sphereface/caffe && 
...
cd /workspace/nn_models/object_detection/common/mobilenet-ssd/caffe && 
...
cd /workspace/nn_models/object_detection/common/mtcnn/o/caffe && 
...
cd /workspace/nn_models/object_detection/common/mtcnn/p/caffe && 
...
cd /workspace/nn_models/object_detection/common/mtcnn/r/caffe && 
...
cd /workspace/nn_models/object_detection/common/ssd/300/caffe && 
...
cd /workspace/nn_models/object_detection/common/ssd/512/caffe && 
...
cd /workspace/nn_models/semantic_segmentation/dilation/cityscapes/caffe && 
